    ...
    <div class="sidebar-inner slimscrollleft">
        ...
        <div id="sidebar-menu">
            <ul>
                ...
                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect"><i class="dripicons-briefcase"></i> <span> Formations </span> <span class="menu-arrow float-right"><i class="mdi mdi-chevron-right"></i></span></a>
                    <ul class="list-unstyled">
                        <li><a href="ui-alerts.html">Nouvelle Formation</a></li>
                        <li><a href="ui-buttons.html">Liste de formations</a></li>
                        <li><a href="ui-badge.html">Gestion de formations</a></li>
                        <li><a href="ui-badge.html">Formateurs</a></li>
                    </ul>
                </li>

                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect"><i class="dripicons-broadcast"></i> <span> Offres/récrutements </span> <span class="menu-arrow float-right"><i class="mdi mdi-chevron-right"></i></span></a>
                    <ul class="list-unstyled">
                        <li><a href="reservations.php">Nouvelle offre</a></li>
                        <li><a href="advanced-rating.html">Liste des offres</a></li>
                        <li><a href="advanced-nestable.html">Gestion des offres</a></li>
                    </ul>
                </li>

                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect"><i class="dripicons-document"></i><span> Fiche de contrôles </span> <span class="badge badge-warning badge-pill float-right">8</span></a>
                    <ul class="list-unstyled">
                        <li><a href="form-elements.html">Employés</a></li>
                        <li><a href="form-validation.html">Liste des fiches</a></li>
                        <li><a href="form-advanced.html">Gestions des fiches</a></li>
