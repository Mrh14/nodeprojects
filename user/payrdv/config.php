...
//define('PAYPAL_RETURN_URL', 'https://visio.fcpo.agency/user/payrdv/success.php');
//define('PAYPAL_CANCEL_URL', 'https://visio.fcpo.agency/user/payrdv/cancel.php');
define('PAYPAL_RETURN_URL', 'http://localhost/nodeprojects2/user/payrdv/success.php');
define('PAYPAL_CANCEL_URL', 'http://localhost/nodeprojects2/user/payrdv/cancel.php');
